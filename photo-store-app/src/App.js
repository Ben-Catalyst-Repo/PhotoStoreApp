...
// import ToggleView from "./pages/ToggleView";
...
//     return (
//         <h1 
//             className="text-2xl px-4 font-bold cursor-pointer hover:text-gray-300 transition duration-300"
//             onClick={() => navigate("/")}
//         >
//             Photo Store App
//         </h1>
...
//                                 <li className="py-2 px-4 cursor-pointer hover:bg-gray-700" onClick={() => { setOpen(false); navigate("/shared"); }}>Shared Images</li>
//                                 <li className="py-2 px-4 cursor-pointer hover:bg-gray-700" onClick={() => { setOpen(false); navigate("/your-images"); }}>Your Images</li>
//                             </ul>
//                             <ul className="pb-14 mt-auto">
...
//                             className="bg-red-700 text-white px-4 py-2 rounded-md hover:bg-red-900 transition duration-300">
//                             Logout
//                         </button>
//                     </li>
//                 </ul>
...
//                 ) : isUserAuthenticated ? (
//                     <Routes>
//                         <Route path="/" element={<Grid userId={userId} />} />
//                         <Route path="/upload" element={<Upload userId={userId} />} />
//                         <Route path="/list" element={<List userId={userId} />} />
            ...
            <div className="flex-grow flex justify-center items-center overflow-hidden">
                {isFetching ? (
                    ...
                    <Routes>
                        ...
                        <Route path="/upload" element={<Upload userId={userId} />} />
                        {/* <Route path="/list" element={<List userId={userId} />} /> */}
                        {/* <Route path="/sharedImages" element={<SharedGrid userId={userId} />} /> */}
